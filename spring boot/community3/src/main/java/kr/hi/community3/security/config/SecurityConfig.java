package kr.hi.community3.security.config;
...
import kr.hi.community3.security.filter.JwtAuthenticationFilter;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            //매번 컨트롤러를 추가할 때마다 어노테이션을 추가하기 번거로음
            ...
            //UserDetailService를 구현한 구현 클래스의 객체만 올수 있음

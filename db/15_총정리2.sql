...
슈퍼키
- 테이블에서 행을 유일하게(최대 1개로) 식별(검색)할수 있는 하나의 속성 또는 속성의 집합
후보키
...
- 용어
	- DELIMITER 기호
		- 문장 끝을 나타내는 기호를 설정
	- IN : 프로시저의 매개변수를 넘겨주는 값
    - OUT : 프로시저의 매개변수를 넘겨 받는 값
    - INOUT : 프로시저의 매개변수를 넘겨주고 난 뒤 넘겨 받는 값 
    - DELCARE 
		- 변수 선언 시 사용

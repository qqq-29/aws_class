...
value("abc123", "abc123", "abc123@naver.com", "011-1111-2222");
...
select cart.amount, "서울시", id, product.code, price * cart.amount from cart
...
VALUES("ACC003", "반빡이는 귀걸이", "", 10, 50000, 1),

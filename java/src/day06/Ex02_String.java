...
public class Ex02_String {
	...
	public static void main(String[] args) {
		 ...
		 * - 문자열이 변경되면 기존 문자열에서 변경되는게 아니라 새로운 문자열 만들어서 연결
		 * 	 예시
		 *   String str = "abc";
		 *   str = str + "d"; //abc 뒤에 d를 이어 붙이는게 아니라 abcd라는 문자열을 새로 만들어 연결
		 * 
		 * StringBuffer(쓰레드 지원) 와 StringBuilder p380
		 * - char[]로 문자열을 관리
		 * - 둘의 차이는 쓰레드 지원여부
		 * 
		 * String 클래스 메서드
		 * - indexOf("문자열") : 문지열이 있으면 시작 번지를 알려줌
		 * - equals("문자열") : 두 문자열이 같인즈 비교하여 true/false를 반환

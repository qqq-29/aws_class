...
public class Ex08_Operator2 {
	...
	public static void main(String[] args) {
		...
		/*단락 회로 평가(SCE : Short Circuit Evaluation) p77
		 * - 논리 연산자로 연산할 때 발생
		 * - 속도 향상
		...
		int num1 = 50, num2 = 50;
		System.out.println("num1 과 num2 중 하나라도 60이상입니까" + (num1>=60 || (num2=60)>=60));
		...
		String even = 10%2 == 0 ? "짝수" : "홀수";
		System.out.println(num4 + "은 짝수?" + isEven);
		System.out.println(num4 + "은 짝수?" + even);
		
		/*비트 연산자 p81
		 * - 비트 논리 연산자
		 * 		- 정수를 2진수로 표현한 후 각 비트로 나열하여 논리 연산
		 * 		- 1 : true, 0 : false
		 * 		- |,&,~,^(xor)
		 * 			- | : or
		 * 			- & : and

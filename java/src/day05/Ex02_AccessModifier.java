...
class Student{
	...
	//setter
	//매개변수 : 보통 필드와 같은 자료형의 변수가 옴
	//메거드명 : set필드명으로 작성. 필드명은 대문자로 시작

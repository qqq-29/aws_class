...
public class Ex01_Exception {
	...
	public static void main(String[] args) {
		 ...
		 *   - 예외처리를 하지 않아도 코드상 오류가 발생 => 반드시 예외처리를 해야 함
		 *   
		 * 예외 처리 방법
		 * 1. 예외가 발생한 곳에서 직접 처리 p523
		 * - 예외처리하기
		 * - 문법
		 *  try{
		 *  	예외가 발생할 수 있는 코드
		 ...
		 * 2. 예외가 발생한 곳에서 처리하지 않고 호출한 메서드에게 넘기는 방법 p534
		 * - 예외 처리 미루기, 예외 처리 던지기
		 * - 예외가 생길 코드에 예외 던지기
		 * 	 - 예외가 발생할 수 있는 상활을 조건문으로 처리하고 throw를 이용하여 예외를 던짐
...
//		FileOutputStream fos = new FileOutputStream("");
		...
		}catch(Exception e) {//모두의 조상클래스(예외처리 점점 크야됨)
	...
	public static void exceptionTest(){
		try {
			...
			System.out.println("무조건 실행 됩니다");//return이 있어도 실행
		}
